...
namespace Admin\ExerciceBundle\Controller;

use Admin\ExerciceBundle\Entity\Exercice;
...
class ExerciceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $exercices = $em->getRepository('AdminExerciceBundle:Exercice')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\ExerciceBundle\Form\ExerciceType', $exercice);
    ...
    {
        $deleteForm = $this->createDeleteForm($exercice);
        $editForm = $this->createForm('Admin\ExerciceBundle\Form\ExerciceType', $exercice);
